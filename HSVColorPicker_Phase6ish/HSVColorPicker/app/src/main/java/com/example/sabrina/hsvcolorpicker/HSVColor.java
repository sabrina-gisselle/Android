...
public class HSVColor {
    ...
    public static float hueDelta = 10f;
    public static float hueCenter = 120f;
    public static float difference = 360f/hueDelta;
    public static float saturationDelta = 10f;
    public static float valueDelta = 10f;
